...
class Website(WebsiteSale):
    ...
    def cart_update(self, product_id, add_qty=1, set_qty=0, **kw):
        ...
        if kw.get('attrib'):
            ...
            result =  super(Website, self).cart_update(product_id, add_qty, set_qty, **kw)
            return result 
    ...
    def cart_update_json(self, product_id, line_id=None, add_qty=None, set_qty=None, display=True, **kw):
        ...
        if kw.get('attrib'):
            ...
            result =  super(Website, self).cart_update_json(product_id, line_id, add_qty, set_qty, display, **kw)
            return result 
